...
import CategoryListScreen from '../AdminScreen/categorymanagement/CategoryList';
import TrashCategoryScreen from '../AdminScreen/categorymanagement/TrashCategory';
...
export default function AdminStack() {
  return (
    ...
    >
      ...
      <Stack.Screen name="TrashCategory" component={TrashCategoryScreen} />
    </Stack.Navigator>
  );
}