      ...
      <View style={styles.requirementsCard}>
        ...
        <View style={styles.requirementItem}>
          <Ionicons 
            ...
            size={18} 
            color={formData.newPassword.length >= 8 ? "#4CAF50" : "#64748B"} 
          />
        ...
        <View style={styles.requirementItem}>
          <Ionicons 
            ...
            size={18} 
            color={/[A-Z]/.test(formData.newPassword) ? "#4CAF50" : "#64748B"} 
          />
        ...
        <View style={styles.requirementItem}>
          <Ionicons 
            ...
            size={18} 
            color={/\d/.test(formData.newPassword) ? "#4CAF50" : "#64748B"} 
          />
        ...
        {formData.newPassword && formData.confirmPassword && (
          <View style={styles.matchIndicator}>
            <Ionicons 
              ...
              size={20} 
              color={formData.newPassword === formData.confirmPassword ? "#4CAF50" : "#0EA5E9"} 
            />
            <Text style={[
              styles.matchText,
              { color: formData.newPassword === formData.confirmPassword ? "#4CAF50" : "#0EA5E9" }
